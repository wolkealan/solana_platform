// src/components/models/RpmGirl5.jsx
import { useAnimations, useGLTF } from '@react-three/drei';
import React, { useEffect, useRef, useMemo } from 'react';
import { clone } from 'three/examples/jsm/utils/SkeletonUtils';
import { useHeadTracking } from '../../hooks/useHeadTracking';

export function RpmGirl5(props) {
  // Load the RPM Girl5 model
  const { nodes: originalNodes, materials, scene: originalScene } = useGLTF('/models/rpmgirl5.glb');
  
  // Load the animation for RPM Girl5
  const { animations: originalAnimations } = useGLTF('/animations/g5_mod.glb');
...
// Preload assets
useGLTF.preload('/models/rpmgirl5.glb');
useGLTF.preload('/animations/g5_mod.glb');