// src/components/models/RpmOrangie.jsx
import { useAnimations, useGLTF } from '@react-three/drei';
import React, { useEffect, useRef, useMemo } from 'react';
import { clone } from 'three/examples/jsm/utils/SkeletonUtils';
import { useHeadTracking } from '../../hooks/useHeadTracking';

export function RpmOrangie(props) {
  // Load the RPM Orangie model
  const { nodes: originalNodes, materials, scene: originalScene } = useGLTF('/models/rpmorangie.glb');
  
  // Load the animation for RPM Orangie
  const { animations: originalAnimations } = useGLTF('/animations/oranige_mod.glb');
...
// Preload assets
useGLTF.preload('/models/rpmorangie.glb');
useGLTF.preload('/animations/oranige_mod.glb');