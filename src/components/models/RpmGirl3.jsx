// src/components/models/RpmGirl3.jsx
import { useAnimations, useGLTF } from '@react-three/drei';
import React, { useEffect, useRef, useMemo } from 'react';
import { clone } from 'three/examples/jsm/utils/SkeletonUtils';
import { useHeadTracking } from '../../hooks/useHeadTracking';

export function RpmGirl3(props) {
  // Load the RPM Girl3 model
  const { nodes: originalNodes, materials, scene: originalScene } = useGLTF('/models/rpmgirl3.glb');
  
  // Load the animation for RPM Girl3
  const { animations: originalAnimations } = useGLTF('/animations/g3_mod.glb');
...
// Preload assets
useGLTF.preload('/models/rpmgirl3.glb');
useGLTF.preload('/animations/g3_mod.glb');