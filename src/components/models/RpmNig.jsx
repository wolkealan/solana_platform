// src/components/models/RpmNig.jsx
import { useAnimations, useGLTF } from '@react-three/drei';
import React, { useEffect, useRef, useMemo } from 'react';
import { clone } from 'three/examples/jsm/utils/SkeletonUtils';
import { useHeadTracking } from '../../hooks/useHeadTracking';

export function RpmNig(props) {
  // Load the RPM model
  const { nodes: originalNodes, materials, scene: originalScene } = useGLTF('/models/rmpnig.glb');
  
  // Load the animation
  const { animations: originalAnimations } = useGLTF('/animations/nig_mod.glb');
...
// Preload assets
useGLTF.preload('/models/rmpnig.glb');
useGLTF.preload('/animations/nig_mod.glb');