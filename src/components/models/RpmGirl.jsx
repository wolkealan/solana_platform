// src/components/models/RpmGirl.jsx
import { useAnimations, useGLTF } from '@react-three/drei';
import React, { useEffect, useRef, useMemo } from 'react';
import { clone } from 'three/examples/jsm/utils/SkeletonUtils';
import { useHeadTracking } from '../../hooks/useHeadTracking';

export function RpmGirl(props) {
  // Load the RPM girl model
  const { nodes: originalNodes, materials, scene: originalScene } = useGLTF('/models/rpmgirl1.glb');
  
  // Load the animation for RPM girl
  const { animations: originalAnimations } = useGLTF('/animations/g1ani.glb');
...
// Preload assets
useGLTF.preload('/models/rpmgirl1.glb');
useGLTF.preload('/animations/g1ani.glb');