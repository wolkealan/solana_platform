// src/components/models/RpmSigma.jsx
import { useAnimations, useGLTF } from '@react-three/drei';
import React, { useEffect, useRef, useMemo } from 'react';
import { clone } from 'three/examples/jsm/utils/SkeletonUtils';
import { useHeadTracking } from '../../hooks/useHeadTracking';

export function RpmSigma(props) {
  // Load the RPM Sigma model
  const { nodes: originalNodes, materials, scene: originalScene } = useGLTF('/models/rpmsigma.glb');
  
  // Load the animation for RPM Sigma
  const { animations: originalAnimations } = useGLTF('/animations/sigma_mod.glb');
...
// Preload assets
useGLTF.preload('/models/rpmsigma.glb');
useGLTF.preload('/animations/sigma_mod.glb');