// src/components/models/RpmGirl2.jsx
import { useAnimations, useGLTF } from '@react-three/drei';
import React, { useEffect, useRef, useMemo } from 'react';
import { clone } from 'three/examples/jsm/utils/SkeletonUtils';
import { useHeadTracking } from '../../hooks/useHeadTracking';

export function RpmGirl2(props) {
  // Load the RPM Girl2 model
  const { nodes: originalNodes, materials, scene: originalScene } = useGLTF('/models/rpmgirl2.glb');
  
  // Load the animation for RPM Girl2
  const { animations: originalAnimations } = useGLTF('/animations/g2_mod.glb');
...
// Preload assets
useGLTF.preload('/models/rpmgirl2.glb');
useGLTF.preload('/animations/g2_mod.glb');